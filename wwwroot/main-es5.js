...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _node_modules_ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_2__["BrowserAnimationsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_49__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_13__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["FormsModule"], _node_modules_ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_48__["BsDatepickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["ReactiveFormsModule"], MaterialModule],
        ...
        value: function authorize() {
          ...
          if (this.loginForm.valid) {
            ...
            this.authService.login$(user).subscribe(function () {
              ...
              if (error.status === 401) {
                if (!_this.error.state) {
                  _this.error.state = !_this.error.state;
                  _this.error.message = error.error;
                  console.log(error);
                }
              }
            });
        ...
        value: function authorization() {
          ...
          if (this.registerForm.valid) {
            ...
            this.authService.register$(user).subscribe(function () {
              return _this2.authService.login$(user).subscribe(function () {
                return _this2.router.navigateByUrl('/home');
              }, function (error) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\reds\Desktop\Task\TaskSPA\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
